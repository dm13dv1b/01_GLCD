...
/* Global Variables */
static volatile unsigned char x_ks0108, y_ks0108;

/* Functions */

static void strobe_ks0108(void){
...
static void wait_busy_ks0108(void){
...
static void putcmd_ks0108(char ins){
...
static unsigned char getd_ks0108(void){
	char data;
...
static void putd_ks0108(unsigned char data){
	if(x_ks0108==0){
...
static void gotoxy_ks0108(unsigned char x, unsigned char y){
	x_ks0108 = x;
	y_ks0108 = y;
	if(x_ks0108<64){
		KS0108_L();							/* Select Chip */
...
static void putc_ks0108(unsigned char c){
	int i;
	switch(c){
...
static void puts_ks0108(unsigned char *s){
	do{
		putc_ks0108(*s);
	}while(*++s);
}
